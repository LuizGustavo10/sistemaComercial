            ...
            <form action="<?= $destino ?>" method="post">
              ...
              <div class="form-group">
                ...
                <input required value="<?php echo isset($dadosAlt) ? $dadosAlt['nome'] : '' ?>" type="text" name="nome"
                  class="form-control" placeholder="Nome da area">
              </div>
              ...
              <tbody>
                ...
                while ($colunas = mysqli_fetch_assoc($resultado)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="area.php?idAlt=<?= $colunas['id'] ?>"> <i class="fa-solid fa-pen-to-square mr-3"></i>
                      </a>
                      <a href="<?php echo './area/excluir.php?id=' . $colunas['id']; ?>"> <i
