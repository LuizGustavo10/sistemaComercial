        ...
        <div class="row">
          ...
          <div class="col-md-4 card">
            ...
            <form action="<?= $destino ?>" method="post">
              ...
              <div class="form-group">
                <label>CPF: </label>
                <input value="<?php echo isset($dadosAlt) ? $dadosAlt['cpf'] : '' ?>" type="text" name="cpf"
                  class="form-control cpf" placeholder="Seu CPF">
              </div>
              ...
              <tbody>
                ...
                while ($colunas = mysqli_fetch_assoc($resultado)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="principal.php?idAlt=<?= $colunas['id'] ?>"> <i class="fa-solid fa-pen-to-square mr-3"></i>
                      </a>
