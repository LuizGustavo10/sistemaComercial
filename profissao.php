          ...
          <div class="col-md-4 card">
            ...
            <form action="<?= $destino ?>" method="post">
              ...
              <div class="form-group">
                ...
                <input required value="<?php echo isset($dadosAlt) ? $dadosAlt['descricao'] : '' ?>" type="text" name="descricao"
                  class="form-control" placeholder="Nome da profissão">
              </div>

              <div class="form-group">
                <label>Observação: </label>
                <input value="<?php echo isset($dadosAlt) ? $dadosAlt['obs'] : '' ?>" type="text" name="obs"
                  class="form-control cep" placeholder="Observação">
              </div>
              ...
              <tbody>
                ...
                while ($colunas = mysqli_fetch_assoc($resultado)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="profissao.php?idAlt=<?= $colunas['id'] ?>"> <i class="fa-solid fa-pen-to-square mr-3"></i>
                      </a>
